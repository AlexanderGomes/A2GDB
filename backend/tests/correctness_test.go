...
// 		rows, _, res := sharedDB.EngineEntry(encodedPlan1, false, true)
// 		if res.Error != nil {
// 			t.Fatal(res.Error)
// 		}
...
// 		_, groupMap, _ := sharedDB.EngineEntry(encodedPlan1, false, true)
...
// 		t.Fatal(err)
// 	}
// 	_, _, res := sharedDB.EngineEntry(encodedPlan1, false, true)
